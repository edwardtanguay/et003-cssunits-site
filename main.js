...
document.querySelector('#app').innerHTML = `
	...
	<article>
		<h2>Specificity</h2>
		<p>Specificity refers to the relative weights of various rules. It determines which styles apply to an element when more than one rule could apply. Based on the specification, a simple selector (e.g. H1) has a specificity of 1, class selectors have a specificity of 1,0, and ID selectors have a specificity of 1,0,0.</p>
		<p>Because the specificity values do not carry over as in the decimal system, commas are used to separate the "digits" (a CSS rule having 11 elements and 11 classes would have a specificity of 11,11, not 121). In the above example, the declaration in the style attribute overrides the one in the style element because it has a higher specificity, and thus, the paragraph appears green.</p>
	</article>
`